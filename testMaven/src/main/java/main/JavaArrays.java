...
// con valores
  ...
  public static void Ejercicio14(Scanner sc) {
    ...
    System.out.println("Vas a introducir " + tablaA.length + " números enteros dos veces de forma creciente, para llenar dos tablas, y te los voy a juntar y mostrar sin perder el orden creciente.");
    ...
    int indiceB = 0;
    for (int i = 0; i < 20; i++) {
      //no pongo un if de si tanto indiceA como indiceB están llenos porque en ese caso i debe ser 20.
      //si alguna de las dos tablas ya está insertada entera, insertará lo que queda de la otra
      if (indiceA >= 10) {
	...
	indiceA++;
	//Contrasta ahora según el índice por el que vaya de cada tabla los números menores de cada una para insertar el menor
  ...
  public static void Ejercicio16(Scanner sc) {
    ...
    System.out.println("Vas a introducir las notas de 5 alumnos, de 3 evaluaciones. Después mostraré al final: la nota media del\n"
	...
	System.out.println("Introduce BIEN la nota (de 0 a 10) del alumno " + (i + 1) + " en la primera evaluación: ");
	alumnos[0][i] = sc.nextDouble();
	sc.nextLine();
      }
    }
	...
	System.out.println("Introduce BIEN la nota (de 0 a 10) del alumno " + (i + 1) + " en la segunda evaluación: ");
	alumnos[1][i] = sc.nextDouble();
	sc.nextLine();
      }
    }
	...
	System.out.println("Introduce BIEN la nota (de 0 a 10) del alumno " + (i + 1) + " en la tercera evaluación: ");
	alumnos[2][i] = sc.nextDouble();
	sc.nextLine();
      }
    }
    ...
    System.out.println("¿De qué alumno quieres la media? (de 0 a " + cantidadAlumnos + ") (introduce solo el número entero): ");
    int N = sc.nextInt();
    sc.nextLine();
    ...
    System.out.println("La media del alumno " + N + " es " + ((alumnos[0][N] + alumnos[1][N] + alumnos[2][N]) / 3) + ".");
